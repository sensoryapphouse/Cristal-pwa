...
window.requestAnimationFrame = domAPI('requestAnimationFrame') || function (frame) {
...
Viewport = _.prototype({
    ...
    vertexBuffer: function (cfg) {
        return new VertexBuffer(_.extend({
            gl: this.gl
        }, cfg))
    },
    shaderProgram: function (cfg) {
        return new ShaderProgram(_.extend({
            gl: this.gl
        }, cfg))
    },
    texture: function (cfg) {
        return new Texture(_.extend({
            gl: this.gl
        }, cfg))
    },
    renderTexture: function (cfg) {
        return new RenderTexture(_.extend({
            gl: this.gl
        }, cfg))
    },
    slowrender: function () {
